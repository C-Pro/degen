...
func easyjson72cd9c75DecodeDegenPkgConnectorsBinance3(in *jlexer.Lexer, out *BinanceReq) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson72cd9c75EncodeDegenPkgConnectorsBinance3(out *jwriter.Writer, in BinanceReq) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
// MarshalJSON supports json.Marshaler interface
func (v BinanceReq) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
...
// MarshalEasyJSON supports easyjson.Marshaler interface
func (v BinanceReq) MarshalEasyJSON(w *jwriter.Writer) {
	easyjson72cd9c75EncodeDegenPkgConnectorsBinance3(w, v)
}

// UnmarshalJSON supports json.Unmarshaler interface
func (v *BinanceReq) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
...
// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *BinanceReq) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson72cd9c75DecodeDegenPkgConnectorsBinance3(l, v)
}
func easyjson72cd9c75DecodeDegenPkgConnectorsBinance4(in *jlexer.Lexer, out *Binance) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "API":
			if in.IsNull() {
				...
				easyjson72cd9c75DecodeDegenPkgConnectorsBinance5(in, out.API)
			}
		default:
			in.SkipRecursive()
		}
...
func easyjson72cd9c75EncodeDegenPkgConnectorsBinance4(out *jwriter.Writer, in Binance) {
	out.RawByte('{')
	first := true
	_ = first
	{
		...
		if in.API == nil {
			...
			easyjson72cd9c75EncodeDegenPkgConnectorsBinance5(out, *in.API)
		}
	}
	out.RawByte('}')
}
...
// MarshalJSON supports json.Marshaler interface
func (v Binance) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
...
// MarshalEasyJSON supports easyjson.Marshaler interface
func (v Binance) MarshalEasyJSON(w *jwriter.Writer) {
	easyjson72cd9c75EncodeDegenPkgConnectorsBinance4(w, v)
}

// UnmarshalJSON supports json.Unmarshaler interface
func (v *Binance) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
...
// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *Binance) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson72cd9c75DecodeDegenPkgConnectorsBinance4(l, v)
}
func easyjson72cd9c75DecodeDegenPkgConnectorsBinance5(in *jlexer.Lexer, out *API) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson72cd9c75EncodeDegenPkgConnectorsBinance5(out *jwriter.Writer, in API) {
	out.RawByte('{')
	first := true
	_ = first
	out.RawByte('}')
